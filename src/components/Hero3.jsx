...
import h1 from '../Images/aboutimg5.png'
import h2 from '../Images/aboutimg5.png'
import h3 from '../Images/aboutimg5.png'
...
const Hero3 = () => {
  ...
  return (
    <HeroContainer ref={sliderRef}>
      <HeroContent>
        <HeroTitle isVisible={isVisible}>ABOUT AJGA </HeroTitle>
        <HeroSubtitle isVisible={isVisible}>
        Your world-class Journal
        </HeroSubtitle>
      </HeroContent>
      <Slider
